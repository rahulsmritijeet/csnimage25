...
.bg-gradient-overlay {
  background: linear-gradient(135deg, 
    rgba(10, 10, 10, 0.5) 0%,    /* Reduced opacity from 0.3 to 0.5 */
    rgba(0, 20, 40, 0.4) 50%,     /* Reduced opacity from 0.2 to 0.4 */
    rgba(10, 10, 10, 0.5) 100%);  /* Reduced opacity from 0.3 to 0.5 */
}
